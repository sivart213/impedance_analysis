...
def cli():
    """
    Command line interface to select the target GUI.

    Returns
    -------
    Gui : type
        The selected GUI class.
    """
    ...
    return _args, run_steps


def main():
    """
    Main function to run DC data processing steps based on command line arguments.
    """
    _args, run_steps = cli()
